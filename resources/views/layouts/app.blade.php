...
<head>
    ...
    <!-- Scripts -->
    {{-- defer causes problems with selected & jquery libraries --}}
                ...
                <div class="row">
                    <div class="col-md-4 py-4">
                        <ul class="list-group">
                            ...
                            @endif
                            <li class="list-group-item"><a href="{{ route('users.prof', Auth()->user()->id) }}">Profile</a></li>
                            ...
                            <li class="list-group-item"><a href="{{ route('trash.index') }}">Trash</a></li>
                        </ul>
                    </div>
                    <div class="col-md-8">
                        <main class="py-4">
